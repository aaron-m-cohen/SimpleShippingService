...
public class PrepareShipmentRequest {
    ...
    */
     ...
     * @param asin - The asin of the item being shipped
     * @param description - A description of the item.
     * @param length - Length of the item.
     * @param width - Width of the item.
     * @param height - Height of the item.
     * @param fcCode - Code of the fulfillment center from where the item will be shipped.
     */
    ...
    /**
     * Builder constructor.
     * @param builder - The builder used to construct a PrepareShipmentRequest.
     */
